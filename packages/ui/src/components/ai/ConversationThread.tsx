 ...
 * consistent spacing. Tokens: thread.* . Spec: specs/conversation-thread/index.md
 */
export const ConversationThread = forwardRef<HTMLDivElement, ConversationThreadProps>(({ children }, ref) => (
  <Stack ref={ref} gap="lg" role="log" aria-live="polite" style={{ background: 'var(--cds-surface-default)', padding: 16, borderRadius: 8 }}>
    {children}
  </Stack>
));
