 ...
 * Reversibility is a core safety affordance. Tokens: undo.* . Spec: specs/ai/undo-bar/index.md
 */
export const UndoBar = forwardRef<HTMLDivElement, UndoBarProps>(({ message, onUndo }, ref) => (
  <Group ref={ref} justify="space-between" align="center" px="md" py="xs" role="status" aria-live="polite"
    style={{ background: 'var(--tds-text-primary)', borderRadius: 8 }}>
    <Text size="sm" style={{ color: 'var(--tds-text-on-action)' }}>{message}</Text>
