...
| `interaction_states` | Every state must be implemented, and coverage is checked by Storybook evidence, painted-DOM pseudo-state sampling, or the explicit state-coverage gap ledger. |
