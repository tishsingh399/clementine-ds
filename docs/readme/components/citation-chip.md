...
[Spec](https://github.com/tishsingh399/clementine-ds/blob/main/specs/citation-chip/index.md) | [Code](https://github.com/tishsingh399/clementine-ds/blob/main/packages/ui/src/components/ai/CitationChip.tsx) | [Tokens](https://github.com/tishsingh399/clementine-ds/blob/main/packages/tokens/src/components/citation-chip.json)

## Overview

Inline provenance — a superscript [n] marker that links to its source.

Status: `AI-Ready`. Token contract closed at 4 component-tier tokens. Full contract, parts, ARIA, and interaction states are in the [spec](https://github.com/tishsingh399/clementine-ds/blob/main/specs/citation-chip/index.md).
...
- [Spec — full anatomy, ARIA, states](https://github.com/tishsingh399/clementine-ds/blob/main/specs/citation-chip/index.md)
