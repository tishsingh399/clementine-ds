...
| 📐 Figma | [Clementine DS Figma file](https://www.figma.com/design/kPBBglpMr7MVjejDjc19hy/Clementine-DS) | 3 variable collections; **all 31 components' tokens synced as variables (240 component vars, aliased through the cascade)**. Original 10 rendered as full components; the 21 new ones on the **"New Components (Tier-3 bound)"** board as variable-bound swatch groups |
