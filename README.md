...
| 📐 Figma | [Clementine DS Figma file](https://www.figma.com/design/w4JB0MOEIzOtSKx5Y3YSQR/Clementine-DS) | 3 variable collections; **114 of 121 components synced — tokens as variables (571 component vars, cascade-aliased) + rendered as real components** across 6 category pages — Actions & Inputs · Containers & Navigation · Display & Feedback · AI Surfaces · Enterprise · Trust & Feedback — plus a Cover page. The 7 newest (dates/charts/toast/carousel) are pending the next Figma sync. |
