...
|---|---|---|
| `memory-panel.bg` | `{surface.elevated}` | `#ffffff` |
| `memory-panel.border` | `{border.default}` | `#e5e5e0` |
| `memory-panel.fg` | `{text.primary}` | `#1a1a18` |
| `memory-panel.remove` | `{text.secondary}` | `#6b6b66` |
